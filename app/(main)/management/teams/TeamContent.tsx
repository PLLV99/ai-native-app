...
const SAMPLE_TEAMS: Team[] = [
    {
        id: "1",
        name: "AI Development",
        description: "Builds the AI and machine learning systems behind our core products",
        status: "active",
        projects: 4,
    ...
    },
    {
        id: "2",
        name: "Frontend Team",
        description: "Builds UI/UX and frontend with Next.js, React and Tailwind",
        status: "active",
        projects: 3,
    ...
    },
    {
        ...
        description: "Owns data pipelines and the vector database powering AI features",
        status: "active",
        projects: 2,
    ...
    },
    {
        id: "4",
        name: "QA & Testing",
        description: "Software quality assurance and AI model evaluation",
        status: "inactive",
        projects: 1,
...
export default function TeamContent() {
    ...
    const stats = [
        { label: "Total Teams", value: teams.length, icon: Users, color: "text-blue-600 dark:text-blue-400", bg: "bg-blue-50 dark:bg-blue-900/20" },
        { label: "Active Teams", value: activeTeams, icon: UserCheck, color: "text-emerald-600 dark:text-emerald-400", bg: "bg-emerald-50 dark:bg-emerald-900/20" },
        { label: "Total Members", value: totalMembers, icon: UserPlus, color: "text-purple-600 dark:text-purple-400", bg: "bg-purple-50 dark:bg-purple-900/20" },
        { label: "Total Projects", value: totalProjects, icon: Briefcase, color: "text-amber-600 dark:text-amber-400", bg: "bg-amber-50 dark:bg-amber-900/20" },
    ]
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage teams and members in your organization</p>
                </div>
                <button
            ...
            <div className="grid gap-5 lg:grid-cols-2">
                {filteredTeams.map((team) => (
                    <Card
                        key={team.id}
                        className={`group transition-shadow hover:shadow-lg cursor-pointer ${selectedTeam?.id === team.id ? "ring-2 ring-blue-500" : ""
                            }`}
                    ...
                    >
                            ...
                            <div className="flex items-start justify-between">
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <span
                                            className={`text-xs font-medium px-2 py-0.5 rounded-full ${team.status === "active"
                        ...
                        <CardFooter className="border-t dark:border-gray-700 pt-3 pb-4 px-6 flex items-center justify-between">
                            <div className="flex items-center gap-4 text-xs text-muted-foreground">
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <span>Created {new Date(team.createdAt).toLocaleDateString("en-US", { month: "short", year: "numeric" })}</span>
                                </div>
                            </div>
                        </CardFooter>
                        ...
                        {selectedTeam?.id === team.id && (
                            <div className="border-t dark:border-gray-700 px-6 py-4 space-y-3 bg-gray-50/50 dark:bg-gray-800/50 rounded-b-xl">
                                <div className="flex items-center justify-between">
                                    <h4 className="text-sm font-semibold text-gray-900 dark:text-white">All Members</h4>
                                    <button
                                        onClick={(e) => {
                                            e.stopPropagation()
                                    ...
                                    {(["admin", "member", "viewer"] as MemberRole[]).map((role) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex items-center gap-2 p-2.5 rounded-lg border text-sm transition ${inviteRole === role
