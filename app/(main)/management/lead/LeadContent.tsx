...
const interestLabels: Record<string, string> = {
    "ai-chatbot": "Enterprise AI Chatbot",
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Manage Leads coming from the website and various channels
                    </p>
                </div>
                <button
                    onClick={fetchLeads}
                ...
                <div className="text-center py-16">
                    ...
                    <p className="text-muted-foreground mt-1">
                        {searchQuery || filterStatus !== "all"
                            ...
                            : "No Leads yet — Leads will appear here when someone fills out the website form."}
                    </p>
                </div>
            ) : (
                <Card>
                                ...
                                <div className="flex gap-2 flex-wrap">
                                    {Object.entries(statusConfig).map(([key, config]) => (
                                        <button
                                            ...
                                            className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition border ${selectedLead.status === key
                                                    ? `${config.bg} ${config.color} border-current`
                                                    : "border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800"
                                                }`}
                                        >
                                            <span
                                                className={`h-2 w-2 rounded-full ${selectedLead.status === key
                                                        ? config.dotColor
