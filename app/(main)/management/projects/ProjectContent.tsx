...
const SAMPLE_PROJECTS: Project[] = [
    {
        ...
        description: "Build an AI chatbot that answers customer questions automatically using RAG",
        status: "active",
        priority: "high",
        progress: 65,
        members: 4,
    ...
    },
    {
        ...
        description: "Knowledge base management system that powers AI question answering",
        status: "active",
        priority: "medium",
        progress: 80,
        members: 3,
    ...
    },
    {
        ...
        description: "Connect the chat system to a LINE Official Account",
        status: "planning",
        priority: "high",
        progress: 10,
        members: 2,
    ...
    },
    {
        ...
        description: "Build a dashboard showing AI system usage statistics",
        status: "on-hold",
        priority: "low",
        progress: 30,
        members: 2,
    ...
    },
    {
        ...
        description: "AI-powered product recommendation engine for online stores",
        status: "completed",
        priority: "medium",
        progress: 100,
        members: 5,
    ...
    },
    {
        ...
        description: "Add multi-language support to the chatbot (TH, EN, ZH, JP)",
        status: "planning",
        priority: "medium",
        progress: 5,
        members: 3,
        ...
        <div className="space-y-6">
                ...
                <div className="flex gap-2 flex-wrap">
                    {(["all", "active", "completed", "on-hold", "planning"] as const).map((status) => (
                        <button
                            ...
                            className={`px-3.5 py-2 rounded-lg text-sm font-medium transition ${filterStatus === status
            ...
            {filteredProjects.length === 0 ? (
                <div className="text-center py-16">
                    ...
                    <p className="text-muted-foreground mt-1">Try a different search term or change the filter</p>
                </div>
            ) : (
                            ...
                            >
                                ...
                                <CardFooter className="border-t dark:border-gray-700 pt-3 pb-4 px-6 flex items-center justify-between">
                                    <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                                        ...
                                        <span>
                                            Due {new Date(project.dueDate).toLocaleDateString("en-US", { day: "numeric", month: "short", year: "numeric" })}
                                        </span>
                                    </div>
