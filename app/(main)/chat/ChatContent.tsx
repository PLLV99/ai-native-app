...
export default function ChatContent() {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            // Reload sessions to update updatedAt
            await loadSessions()
        } catch (error: any) {
            setMessages((prev) =>
                prev.map((msg) =>
    ...
    return (
        <div className="flex h-[calc(100%+3rem)] -m-6 bg-gray-50 dark:bg-gray-950">
            ...
            <div
                className={`${activeSidebar ? "w-72" : "w-0"
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-3 space-y-1">
                    <p className="text-xs text-gray-400 px-2 mb-2">Chat History</p>
                    ...
                    {sessions.map((s) => (
                        <div
                            key={s.id}
                            className={`group flex items-center rounded-lg transition ${activeSessionId === s.id
                                    ? "bg-gray-700"
                                    : "hover:bg-gray-800"
                                }`}
                        >
                    ...
                    {messages.length === 0 && !isLoadingMessages && (
                        <div className="flex flex-col items-center justify-center h-full text-center text-gray-400">
                            ...
                            <p className="mt-2 max-w-md dark:text-gray-400">
                                ...
                                <br />
                                <span className="text-sm">The system will retain context and utilize information from the Knowledge Base.</span>
                            </p>
