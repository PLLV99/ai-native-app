                ...
                <div className="flex-1 overflow-y-auto">
                    {documents.map((doc) => (
                        <button
                            ...
                            className={`w-full text-left px-4 py-3 border-b border-gray-100 dark:border-gray-800 hover:bg-blue-50 dark:hover:bg-gray-800 transition ${selectedDoc?.id === doc.id ? "bg-blue-50 dark:bg-gray-800 border-l-4 border-l-blue-600" : ""
                                }`}
                        >
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    Last updated: {new Date(selectedDoc.updatedAt).toLocaleString("en-US")}
                                ...
                                {mode === "new" && (
                                    <>
                                        ...
                                        <div className="flex items-center gap-4 my-4">
                                            ...
                                            <span className="text-sm text-gray-400 dark:text-gray-500">or type content directly</span>
                                            <hr className="flex-1 dark:border-gray-700" />
                                        </div>
                                    </>
                                )}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative w-full max-w-md rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-2xl mx-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                AI Chatbot can now retrieve information from this document.
                            </p>
                    ...
                    <div className="relative w-full max-w-md rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-2xl mx-4">
                        <div className="mb-4 flex items-center justify-between">
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                                Delete Document — {selectedDoc.title}
                            </h3>
                            <button
                                onClick={() => setShowDeleteModal(false)}
                                className="inline-flex h-8 w-8 items-center justify-center rounded-lg text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer"
                        ...
                        <div className="space-y-4">
                            <div className="rounded-lg border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20 p-3">
                                <p className="text-sm text-red-700 dark:text-red-400">
                                    ⚠️ Deleting this document cannot be undone. Associated data and Vector Index will be permanently deleted.
                                </p>
                            </div>
                            <p className="text-sm text-gray-500 dark:text-gray-400">
