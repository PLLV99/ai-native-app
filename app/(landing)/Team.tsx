...
const teamMembers = [
    {
        ...
        bio: "Full-Stack Developer & AI Enthusiast — Instructor for the Next.js 16: The AI-Native Developer Masterclass",
    ...
    },
    {
        ...
        bio: "AI & Machine Learning Advisor — Expert in NLP, RAG Architecture, and Vector Databases",
    ...
    },
    {
        name: "Napa Digital",
        role: "UX/UI Designer",
        bio: "Designs beautiful and intuitive User Experiences — Expert in Design Systems and Accessibility",
            ...
            <div className="mx-auto max-w-7xl px-6">
                <div className="mb-16 text-center">
                    ...
                    <p className="mx-auto max-w-2xl text-muted-foreground">
                        The developers and instructors behind the AI-Native Developer Masterclass course.
                    </p>
                </div>
