...
const slides: SlideData[] = [
    {
        ...
        title: "AI Chatbot",
        description:
            "Intelligent chatbot that answers questions from corporate documents. Supports both Web and LINE Messaging API.",
        image:
    ...
    },
    {
        ...
        description:
            "Build an AI Knowledge Base with pgVector and OpenAI Embeddings — search information accurately by meaning.",
        image:
    ...
    }, 
    {
        ...
        description:
            "Better Auth with Social Login, MFA, and RBAC — Enterprise-grade secure authentication system.",
        image:
